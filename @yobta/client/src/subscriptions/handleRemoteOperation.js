import { YOBTA_BATCH, YOBTA_COMMIT, YOBTA_ERROR, YOBTA_RECEIVED, YOBTA_REJECT, } from '@yobta/protocol';
...
export const handleRemoteOperation = (message) => {
    ...
    switch (message.type) {
        case YOBTA_COMMIT: {
            ...
            if (op)
                committed.add({ ...op, time: message.time });
